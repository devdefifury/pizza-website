...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    'inline-block rounded-full bg-[red] text-white font-semibold uppercase tracking-wide text-stone-800 transition-colors duration-300 hover:bg-[lightred] focus:bg-[lightred]  focus:outline-none focus:ring focus:ring-red focus:ring-offset-2 disabled:cursor-not-allowed';
